 ...
 *
 * HonkordGL — internal NetBSD + X11 + optional GLFW bootstrap (library implementation detail)
 * Copyright (C) 2026 Honkord
 */

#ifndef HONKORDGL_NETBSD_PLATFORMSESSION_HPP
#define HONKORDGL_NETBSD_PLATFORMSESSION_HPP
 ...
 *
 * Same bring-up as `X11::Internal::PlatformSession`; use with `NetBSD::WindowBackend::BorrowFromSession`.
 *
 * Typical sequence:
