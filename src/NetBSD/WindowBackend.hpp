 ...
 *
 * HonkordGL — NetBSD / X11 window backend
 * Copyright (C) 2026 Honkord
 */

#ifndef HONKORDGL_NETBSD_WINDOWBACKEND_HPP
#define HONKORDGL_NETBSD_WINDOWBACKEND_HPP
...
namespace HonkordGL::Graphics::NetBSD {

using IpcHelperWindow = X11::IpcHelperWindow;

/**
 * X11 binding for `ApplicationContextSettings` on NetBSD (`NativePlatform::NetBSD`).
 *
...
public:
    ...
    /**
     * Use the display from a bootstrapped `NetBSD::Internal::PlatformSession` (does not take ownership).
     */
