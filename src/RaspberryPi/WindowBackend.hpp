 ...
 *
 * HonkordGL — Raspberry Pi / X11 window backend
 * Copyright (C) 2026 Honkord
 */

#ifndef HONKORDGL_RASPBERRY_PI_WINDOWBACKEND_HPP
#define HONKORDGL_RASPBERRY_PI_WINDOWBACKEND_HPP
...
namespace HonkordGL::Graphics::RaspberryPi {

using IpcHelperWindow = X11::IpcHelperWindow;

/**
 * X11 binding for `ApplicationContextSettings` on Raspberry Pi Linux (`NativePlatform::RaspberryPi`).
 *
...
public:
    ...
    /**
     * Use the display from a bootstrapped `RaspberryPi::Internal::PlatformSession` (does not take ownership).
     */
