    ...
    * @author Honkord <https://github.com>
    ...
    Example build (Linux + X11/Wayland, from repo root — no GPU/GL objects required for this test):
      ...
      g++ -std=c++17 -I include -I src/Wayland \
        ...
        -lX11 -lXrandr -lXi -lwayland-client -lwayland-egl
...
int main()
{
    ...
    settings.window_title = "HonkordGL — TestWindow";
    settings.client_rect.x = 120;
    settings.client_rect.y = 120;
    settings.client_rect.w = 800;
